...
$admin = array(
    ...
    */
    ...
    'drivers'   => array(
        ...
        'add-driver'    => [
            'display'   => true,
            'icon'      => '<div class="fa-3x"><span class="fa-layers fa-fw"><span class="fa-stack fa-2x"><i class="fa-duotone fa-user fa-stack-1x"></i><i class="fa-regular fa-stack-1x fa-steering-wheel fa-inverse" data-fa-transform="shrink-6 down-4"></i></span><i class="fa-solid fa-plus" data-fa-transform="shrink-8 up-6 right-8"></i></span></div>'
        ],
        'view-drivers'    => [
            'display'   => true,
