    ...
    */
    ...
    'drivers'   => array(
        ...
        'default-icon'  => array(
            ...
            'icon'      => '<div class="fa-2x"><span class="fa-stack"><i class="fa-duotone fa-steering-wheel fa-inverse" data-fa-transform="shrink-6 down-4"></i><i class="fa-solid fa-user"></i></span></div>',
