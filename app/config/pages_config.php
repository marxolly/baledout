...
$admin = array(
    ...
    */
    ...
    'drivers'   => array(
        ...
        'default-icon'  => array(
            'display'   => false,
            'icon'      => '<span class="fa-2x align-middle"><i class="fad fa-steering-wheel" data-fa-transform="shrink-4 down-4" data-fa-mask="fad fa-user" style="background:MistyRose"></i></span>',
            'menu-icon' => '<span class="align-middle d-lg-none"><i class="fad fa-steering-wheel" data-fa-transform="shrink-6 down-6" data-fa-mask="fad fa-user"></i></span>'
        )
    ),
    'financials'    => array(
