...
$admin = array(
    ...
    */
    ...
    'drivers'   => array(
        ...
        'default-icon'  => array(
            'display'   => false,
            'icon'      => '<span class="fa-2x align-middle"><i class="fad fa-steering-wheel" data-fa-transform="shrink-4 down-4" data-fa-mask="fad fa-user"></i></span>',
            'menu-icon' => '<span class="align-middle d-lg-none"><i class="fa-solid fa-steering-wheel" data-fa-transform="shrink-4 down-4" data-fa-mask="fad fa-user"></i></span>'
        )
    ),
    'financials'    => array(
