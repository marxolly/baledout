...
$admin = array(
    ...
    */
    ...
    'depots'    => array(
        ...
        'view-depots'   => [
            'display'   => true,
            'icon'      => '<div class="fa-3x"><span class="fa-layers fa-fw"><i class="fa-duotone fa-warehouse-full"></i><i class="fa-solid fa-binoculars" data-fa-transform="shrink-10 rotate-30"></i></span></div>'
        ],
        'edit-depot'  => [
            'display'   => false,
            'icon'      => ''
