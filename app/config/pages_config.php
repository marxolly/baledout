...
$admin = array(
    ...
    */
    'jobs'      => array(
        ...
        'search-jobs' => [
            'display'   => true,
            'icon'      => '<div class="fa-3x"><span class="fa-layers fa-fw"><i class="fa-duotone fa-truck-container"></i><i class="fa-solid fa-search" data-fa-transform="shrink-12 up-4"></i></span></div>'
        ]
    ),
    'clients'	=> array(
        'clients-index' => true,
