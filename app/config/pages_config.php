...
$admin = array(
    ...
    */
    'jobs'      => array(
        ...
        'view-jobs'   => [
            'display'   => true,
            'icon'      => '<div class="fa-3x"><span class="fa-layers fa-fw"><i class="fa-duotone fa-truck-container"></i><i class="fa-solid fa-binoculars" data-fa-transform="shrink-10 up-2 left-2 rotate-30"></i></span></div>'
        ],
        'search-jobs' => [
            'display'   => true,
            'icon'      => '<div class="fa-3x"><span class="fa-layers fa-fw"><i class="fa-duotone fa-truck-container"></i><i class="fa-solid fa-search" data-fa-transform="shrink-10 up-4 left-4"></i></span></div>'
        ]
    ),
    'clients'	=> array(
        'clients-index' => true,
