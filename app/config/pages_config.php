...
$admin = array(
    ...
    */
    ...
    'clients'	=> array(
        ...
        'add-client'   => [
            'display'   => true,
            'icon'      => '<div class="fa-3x"><span class="fa-layers fa-fw"><i class="fa-duotone fa-user-tie"></i><i class="fa-solid fa-plus" data-fa-transform="shrink-8 up-5 right-10"></i></span></div>'
        ],
    ),
    'depots'    => array(
        'depots-index'  => true,
