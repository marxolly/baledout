...
$admin = array(
    ...
    */
    ...
    'clients'	=> array(
        ...
        'view-clients'   => [
            'display'   => true,
            'icon'      => '<div class="fa-3x"><span class="fa-layers fa-fw"><i class="fa-duotone fa-user-tie"></i><i class="fa-solid fa-binoculars" data-fa-transform="shrink-10 up-5 right-3 rotate-30"></i></span></div>'
        ],
    ),
    'depots'    => array(
        'depots-index'  => true,
