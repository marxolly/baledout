...
$admin = array(
    ...
    */
    'jobs'      => array(
        ...
        'add-job'   => [
            'display'   => true,
            'icon'      => '<div class="fa-3x"><span class="fa-layers fa-fw"><i class="fa-duotone fa-truck-container"></i><i class="fa-solid fa-plus" data-fa-transform="shrink-8 up-5 right-12"></i></span></div>'
        ]
    ),
    'clients'	=> array(
        'clients-index' => true,
