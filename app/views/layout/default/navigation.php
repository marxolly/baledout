...
<div class="row fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: transparent; height:120px;">
        <div class="container-fluid">
            <div class="bo_logo">
                <a href="/" class="navbar-brand" title="Portal Home"></a>
            </div>
            <!--ia href="/" class="navbar-brand bo_logo" title="Portal Home">
                <mg class="bo_logo"  src="/images/BO_logo1.png" alt="Baledout Logo" title="Portal Home">
            </a-->
    ...
    <div id="user_info" class="nav-item dropdown col-4 col-lg-2">
